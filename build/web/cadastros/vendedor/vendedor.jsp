            ...
            <table id="tabdados" name="tbusuario" class="table">
                ...
                <tbody>
                    <tr scope="row">
                        ...
                        <td><%= vendedor.getUrl()%></td>
                        <td><%= vendedor.getCpf()%></td>
                        <td><%= vendedor.getSituacao()%></td>
                        <%
                            if (vendedor.getSituacao().equals("A")) {
                        %>
                        <td><a class="btn btn-danger" href="${pageContext.request.contextPath}/VendedorExcluir?idVendedor=<%= vendedor.getIdVendedor()%>">Inativar</a>
                            <%
                            } else {
                            %>
                        <td><a class="btn btn-success" href="${pageContext.request.contextPath}/VendedorExcluir?idVendedor=<%= vendedor.getIdVendedor()%>">Ativar</a>
                            <%
                                }
                            %>
                        <td><a class="btn btn-outline-success" href="${pageContext.request.contextPath}/VendedorCarregar?idVendedor=<%= vendedor.getIdVendedor()%>">Alterar</a>
                    </tr>
                    <%
                        }
                    %>
...
<div class="modal fade" id="CadModal" tabindex="-1" role="dialog" aria-labelledby="CadModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form name="cadastrarUsuario" action="${pageContext.request.contextPath}/VendedorCadastrar" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="url" id="url"maxlength="10">
                    </div>
                    <div class="form-group">
