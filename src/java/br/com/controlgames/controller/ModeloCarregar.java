    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (sessao != null) {
                ...
                Modelo oModelo = (Modelo) dao.carregar(idModelo);
                
                Gson gson = new Gson();
                String jsonModelo = gson.toJson(oModelo);
                response.setCharacterEncoding("UTF-8");
                response.getWriter().write(jsonModelo);            
            ...
            System.out.println("Problemas ao Carregar dados do Modelo! Erro: " + ex.getMessage());
        }
    }
