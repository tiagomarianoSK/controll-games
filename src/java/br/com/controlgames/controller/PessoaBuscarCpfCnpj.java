...
import br.com.controlgames.dao.PessoaDAO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (sessao.getAttribute("idusuario") != null) {
                ...
                int idPessoa = oPessoaDAO.carregarCpf(cpfCnpj);
                String jsonPessoa = oPessoaDAO.carregarJSON(idPessoa);
            ...
            System.out.println("Problemas ao validar cpf/cnpj! Erro: " + ex.getMessage());
        }
    }
