 ...
 * @author wesle
 */
@WebServlet(name = "AmigoCadastrar", urlPatterns = {"/AmigoCadastrar"})
public class AmigoCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Amigo oAmigo = new Amigo(0, observacao,"A",0,cpf,nome);
