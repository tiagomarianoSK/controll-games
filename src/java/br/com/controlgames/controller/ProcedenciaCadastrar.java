 ...
 * @author wesle
 */
@WebServlet(name = "ProcedenciaCadastrar", urlPatterns = {"/ProcedenciaCadastrar"})
public class ProcedenciaCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Procedencia oProcedencia = new Procedencia(0, descricao,"A");
        
        try{
            ProcedenciaDAO dao = new ProcedenciaDAO();
            if(dao.cadastrar(oProcedencia)){
                mensagem = "Procedencia cadastrado com Sucesso!";
            }else{
