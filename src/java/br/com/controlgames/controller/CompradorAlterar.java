 ...
 * @author wesle
 */
@WebServlet(name = "CompradorAlterar", urlPatterns = {"/CompradorAlterar"})
public class CompradorAlterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Comprador oComprador = new Comprador(idComprador, observacao, "A", idComprador, cpf, nome);
        
        try{
            GenericDAO dao = new CompradorDAO();
            if(dao.alterar(oComprador)){
                mensagem = "Comprador alterado com Sucesso!";
            }else{
            ...
            System.out.println("Problemas no Servlet ao alterar comprador! Erro: "+ex.getMessage());
        }
    }
