 ...
 * @author wesle
 */
@WebServlet(name = "TipoItemAlterar", urlPatterns = {"/TipoItemAlterar"})
public class TipoItemAlterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TipoItem oTipoItem = new TipoItem(idTipoItem, descricao, "A");
        
        try{
            HttpSession sessao = request.getSession(false);
            if (sessao != null) {
            TipoItemDAO dao = new TipoItemDAO();
            if(dao.alterar(oTipoItem)){
                mensagem = "TipoItem alterado com Sucesso!";
            }else{
