 ...
 * @author wesle
 */
@WebServlet(name = "VendedorCadastrar", urlPatterns = {"/VendedorCadastrar"})
public class VendedorCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Vendedor oVendedor = new Vendedor(0, url, observacao,"A",0,cpf,nome);
