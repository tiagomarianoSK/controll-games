 ...
 * @author wesle
 */
@WebServlet(name = "RegiaoCadastrar", urlPatterns = {"/RegiaoCadastrar"})
public class RegiaoCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Regiao oRegiao = new Regiao(0, descricao,"A");
        
        try{
            GenericDAO dao = new RegiaoDAO();
            if(dao.cadastrar(oRegiao)){
                mensagem = "Regiao cadastrado com Sucesso!";
            }else{
