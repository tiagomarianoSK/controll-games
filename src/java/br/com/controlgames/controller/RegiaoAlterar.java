 ...
 * @author wesle
 */
@WebServlet(name = "RegiaoAlterar", urlPatterns = {"/RegiaoAlterar"})
public class RegiaoAlterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Regiao oRegiao = new Regiao(idRegiao, descricao, "A");
        
        try{
            HttpSession sessao = request.getSession(false);
            if (sessao != null) {
            RegiaoDAO dao = new RegiaoDAO();
            if(dao.alterar(oRegiao)){
                mensagem = "Regiao alterado com Sucesso!";
            }else{
