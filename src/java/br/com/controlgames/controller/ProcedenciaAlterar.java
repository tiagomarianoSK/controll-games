 ...
 * @author wesle
 */
@WebServlet(name = "ProcedenciaAlterar", urlPatterns = {"/ProcedenciaAlterar"})
public class ProcedenciaAlterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Procedencia oProcedencia = new Procedencia(idProcedencia, descricao, "A");
        
        try{
            HttpSession sessao = request.getSession(false);
            if (sessao != null) {
            ProcedenciaDAO dao = new ProcedenciaDAO();
            if(dao.alterar(oProcedencia)){
                mensagem = "Procedencia alterado com Sucesso!";
            }else{
