 ...
 * @author wesle
 */
@WebServlet(name = "AmigoExcluir", urlPatterns = {"/AmigoExcluir"})
public class AmigoExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (sessao != null) {
            AmigoDAO oAmigoDAO = new AmigoDAO();
            Amigo oAmigo = (Amigo) oAmigoDAO.carregar(idAmigo);
            
            GenericDAO dao = new AmigoDAO();
            if (dao.excluir(oAmigo)) {
                mensagem = "Amigo excluido com Sucesso!";
            }else{
